          ...
          <div className="flex flex-wrap gap-3">
            {ageRanges.map((age) => (
              <button
                ...
                className={`px-6 py-3 rounded-full font-headline font-bold transition-all active:scale-95 ${
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            {activityOptions.map((option) => (
              <button
                ...
                className={`p-5 rounded-xl text-left transition-all active:scale-[0.98] ${
              ...
              >
                <span
                  className={`font-headline font-bold text-lg block ${
                    biometrics.activityLevel === option.id
                      ? "text-primary"
                      : "text-on-surface"
                  }`}
