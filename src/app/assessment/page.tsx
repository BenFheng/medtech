...
export default function AssessmentPage() {
  ...
  return (
    <>
      ...
      <main className="min-h-[calc(100vh-72px)] flex flex-col items-center justify-center px-4 sm:px-6 py-8 md:py-12">
          ...
          <div className="pt-4 md:pt-8 flex justify-between items-center">
            <div>
              {currentStep > 1 && (
                <button
                  onClick={handleBack}
                  className="flex items-center gap-2 px-4 py-3 text-on-surface-variant font-headline font-bold hover:text-primary transition-colors min-h-[44px]"
                >
            ...
            <div className="flex items-center gap-3 md:gap-4">
              <button
                onClick={handleNext}
                disabled={!canProceed()}
                className={`flex items-center gap-2 px-6 sm:px-8 py-3 md:py-4 rounded-lg font-headline font-bold shadow-lg transition-all active:scale-95 min-h-[44px] text-sm sm:text-base ${
                  canProceed()
      ...
      {currentStep === 1 && (
        <section className="bg-surface-container-low py-12 md:py-24 px-4 sm:px-6">
          <div className="max-w-7xl mx-auto space-y-8 md:space-y-12">
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 md:gap-6">
              <div className="max-w-2xl">
                <h2 className="text-2xl md:text-3xl lg:text-4xl font-headline font-bold tracking-tight text-on-background">
                  Why focus matters.
                </h2>
                <p className="text-on-surface-variant mt-3 md:mt-4 text-base md:text-lg">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6">
              <div className="bg-surface-container-lowest p-6 md:p-8 rounded-xl space-y-4 md:space-y-6">
                <div className="w-12 h-12 vitality-accent-gradient rounded-lg flex items-center justify-center">
                  <span className="material-symbols-outlined text-primary">
                    analytics
                  </span>
                </div>
                <h3 className="text-lg md:text-xl font-headline font-bold text-on-background">
                  Bio-Marker Tracking
                </h3>
              ...
              <div className="bg-primary p-6 md:p-8 rounded-xl space-y-4 md:space-y-6 md:scale-105 shadow-2xl shadow-primary/10">
                <div className="w-12 h-12 bg-primary-container rounded-lg flex items-center justify-center">
                  <span className="material-symbols-outlined text-on-primary-container">
                    science
                  </span>
                </div>
                <h3 className="text-lg md:text-xl font-headline font-bold text-on-primary">
                  Evidence-Based
                </h3>
